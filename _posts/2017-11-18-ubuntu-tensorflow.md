...
{{ page.title }}
================
### windows10 + ubuntu 16.04.2 dual boot installtion you can also check this [guide](https://www.tecmint.com/install-ubuntu-16-04-alongside-with-windows-10-or-8-in-dual-boot/).  
**Remember:**  
...
* **Install nvidia driver**  
  ...
  2. Open a terminal and type: 
     ...
     ```
* **Install cuda**  
  1. Download cuda from [here](https://developer.nvidia.com/cuda-release-candidate-download)  
     ```
  ...
  3. Test cuda samples:  
     ...
     ```  
* **Install cudnn**  
  1. Download cudnn from [here](https://developer.nvidia.com/cudnn) to ~/Downloads/  
  2. Type in terminal:  
      ```  
      ...
      ```  
* **Install tensorflow you can also check this [link](https://www.tensorflow.org/install/install_linux)** 
